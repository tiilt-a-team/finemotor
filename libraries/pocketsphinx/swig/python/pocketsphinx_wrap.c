...
#define SWIGTYPE_p_ps_nbest_t swig_types[22]
#define SWIGTYPE_p_ps_seg_t swig_types[23]
...
SWIGINTERN PyObject *_wrap_Decoder_unset_search(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  Decoder *arg1 = (Decoder *) 0 ;
  char *arg2 = (char *) 0 ;
  int *arg3 = (int *) 0 ;
  ...
  int errcode;
  arg3 = &errcode;
  if (!PyArg_ParseTuple(args,(char *)"OO:Decoder_unset_search",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Decoder, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Decoder_unset_search" "', argument " "1"" of type '" "Decoder *""'"); 
  }
  arg1 = (Decoder *)(argp1);
  res2 = SWIG_AsCharPtrAndSize(obj1, &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Decoder_unset_search" "', argument " "2"" of type '" "char const *""'");
  }
  arg2 = (char *)(buf2);
  ...
  resultobj = SWIG_Py_Void();
  {
    if (*arg3 < 0) {
      char buf[64];
      snprintf(buf, 64, "Decoder_unset_search returned %d", *arg3);
      SWIG_exception(SWIG_RuntimeError, buf);
    }
  }
  if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Decoder_unset_search", _wrap_Decoder_unset_search, METH_VARARGS, (char *)"Decoder_unset_search(Decoder self, char const * search_name)"},
