...
def main():
	...
	try:
		...
		if plat.system() == 'Darwin':
                        ...
                        blender = subprocess.Popen('.\\blender.exe -d --python C:\\Users\\plane\\Documents\\GitHub\\finemotor\\tiilt\\blender.py', stdout=subprocess.PIPE, cwd=directory, shell=True)
